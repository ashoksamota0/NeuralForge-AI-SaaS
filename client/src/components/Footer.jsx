...
//                 Experience the power of AI with NeuralForge. <br />Transform your content creation with our suite of premium AI tools. Write articles, generate images, and enhance your workflow.
//             </p>
//         </div>
    ...
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20">
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
          <img className="h-9" src={assets.logo} alt="logo" />
          <p className="mt-6 text-sm">
            Experience the power of AI with NeuralForge. <br />
            ...
            <div className="text-sm space-y-2">
              ...
              <div className="flex items-center gap-2 pt-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 w-24 h-9 text-white rounded cursor-pointer transition-colors"
                >
                  {loading ? "..." : "Subscribe"}
                </button>
              </div>
